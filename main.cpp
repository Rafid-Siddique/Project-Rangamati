...
void cover() {
    ...
    glColor3f(1.0f,1.0f,1.0f);
    renderBitmapString(810, 999, 0.0f, GLUT_BITMAP_HELVETICA_18, " 01412 COMPUTER GRAPHICS [B]");
    renderBitmapString(850, 949, 0.0f, GLUT_BITMAP_HELVETICA_18, "  Somewhere in Rangamati");
    renderBitmapString(870, 909, 0.0f, GLUT_BITMAP_HELVETICA_18, "      Submitted by-  ");


    renderBitmapString(676, 800, 0.0f, GLUT_BITMAP_HELVETICA_18, "ID                                 Name                                                 Contribution ");
    renderBitmapString(676, 750, 0.0f, GLUT_BITMAP_HELVETICA_18, "20-42058-1                KAMIL AHMED                                        25% ");
    renderBitmapString(676, 700, 0.0f, GLUT_BITMAP_HELVETICA_18, "20-42086-1                TAHMID AL RAFID SIDDIQUE               25% ");
    renderBitmapString(676, 650, 0.0f, GLUT_BITMAP_HELVETICA_18, "20-42645-1                MD. MORSHEDUL ISLAM                      25% ");
    renderBitmapString(676, 600, 0.0f, GLUT_BITMAP_HELVETICA_18, "21-45116-2                TAZDIK HOSSAIN                                  25% ");

    renderBitmapString(676, 525, 0.0f, GLUT_BITMAP_HELVETICA_18, "Key Functions:");

    renderBitmapString(676, 486, 0.0f, GLUT_BITMAP_HELVETICA_18, "Press D : To Start Day Mode");
    renderBitmapString(676, 456, 0.0f, GLUT_BITMAP_HELVETICA_18, "Press S : To Start Sunset Mode");
    renderBitmapString(676, 426, 0.0f, GLUT_BITMAP_HELVETICA_18, "Press N : To Start Night Mode");
    renderBitmapString(676, 396, 0.0f, GLUT_BITMAP_HELVETICA_18, "Press T : To Start Thunderstorm Mode");
    renderBitmapString(676, 366, 0.0f, GLUT_BITMAP_HELVETICA_18, "Press C : To Go to Cover Page");
    renderBitmapString(676, 336, 0.0f, GLUT_BITMAP_HELVETICA_18, "Press F : TO Expand to Full Screen");
    renderBitmapString(676, 306, 0.0f, GLUT_BITMAP_HELVETICA_18, "Press L : TO Make Small Screen");
    renderBitmapString(676, 276, 0.0f, GLUT_BITMAP_HELVETICA_18, "Press E : To Exit");




    renderBitmapString(870, 215, 0.0f, GLUT_BITMAP_HELVETICA_18, "  Submitted to");
    renderBitmapString(850, 185, 0.0f, GLUT_BITMAP_HELVETICA_18, "MD. KISHOR MOROL");
    renderBitmapString(850, 160, 0.0f, GLUT_BITMAP_HELVETICA_12, "FACULTY OF SCIENCE & TECHNOLOGY");
    renderBitmapString(850, 140, 0.0f, GLUT_BITMAP_HELVETICA_10, "American International University-Bangladesh");
...
int main(int argc, char ** argv) {
    ...
    cout << endl;
    cout << "               01412 - COMPUTER GRAPHICS [B]" << endl;
    cout << "                 Somewhere in Bandarban" << endl;
    cout << "                    Submitted by-" <<  endl << endl;



    cout << "   ID                             Name                                Contribution" << endl;
    cout << "20-42058-1                KAMIL AHMED                                      25%"<< endl;
    cout << "20-42086-1                TAHMID AL RAFID SIDDIQUE                         25%" << endl;
    cout << "21-45116-2                TAZDIK HOSSAIN                                   25% " << endl;
    cout << "20-42645-1                MD. MORSHEDUL ISLAM                              25%"<<  endl<< endl << endl;

    cout << "Submitted to" << endl;
    cout << "MD. KISHOR MOROL"<< endl;
